  ...
  <main>
    ...
    <section class="webdescript" id="about">  
      <img src="/image/billnwow-logo.png" alt="NWOW Philippines Storefront" width="15%">
        <p>The website provide customer a platform where they can see their bill remotely from anywhere
        and anytime.a web-based platform for administration to manage customer.</p>
